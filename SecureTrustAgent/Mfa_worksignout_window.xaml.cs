...
namespace SecureTrustAgent
{
    ...
    /// </summary>
    public partial class Mfa_worksignout_window : Window
    {
        int g_nCnt = 0;
        ictk_puf_warpper puf_obj;
        DispatcherTimer timer;
        public Mfa_worksignout_window(ictk_puf_warpper puf_Warpper)
        {
            puf_obj = puf_Warpper;
            InitializeComponent();
        ...
        public void update_reset_stat(string strMsg)
        {
            work_cnt.Text = strMsg;
        }
